...
clean-srcs-local::
	...
	$(Q)$(RM) $(PRISM_BUILD_DIR)/parsey/parse.c $(PRISM_BUILD_DIR)/parsey/parse.h
...
$(PRISM_BUILD_DIR)/parsey/parse.c: $(PRISM_SRCDIR)/parsey/parse.y $(PRISM_SRCDIR)/parsey/defs/id.def $(PRISM_SRCDIR)/parsey/tool/id2token.rb $(PRISM_BUILD_DIR)/parsey/.time
	$(ECHO) generating $@
	$(Q)$(BASERUBY) $(PRISM_SRCDIR)/parsey/tool/id2token.rb $(PRISM_SRCDIR)/parsey/parse.y | \
	$(LRAMA) -o$@ -H$(PRISM_BUILD_DIR)/parsey/parse.h - $(PRISM_SRCDIR)/parsey/parse.y
